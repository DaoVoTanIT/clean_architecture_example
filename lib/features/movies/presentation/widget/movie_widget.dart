...
import 'package:news_app_clean_architecture/features/movie_detail/presentation/screen/movie_detail.dart';
...
class MoviesPage extends StatefulWidget {
  final List<NowPlayingMovieModel> movies;
  const MoviesPage({
    Key? key,
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) => MovieDetailPage(
                      id: widget.movies[_current].id.toString(),
                    )),
          );
        },
        child: Stack(
          children: [
            CachedNetworkImage(
                imageUrl: widget.movies[_current].backdropPath ?? '',
                fit: BoxFit.cover,
                height: MediaQuery.of(context).size.height * .56),
            Positioned(
              child: ClipRRect(
